...
const SidebarProvider = React.forwardRef(function (prop: Prop, ref) {
	const { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props } = prop;
