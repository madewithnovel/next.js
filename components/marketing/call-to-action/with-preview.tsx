export default function CallToActionWithPreview () {
	return (
		<div className="container grid grid-cols-2 gap-5 mx-auto px-10">
			<div className="bg-stone-100 rounded-xl p-10">
				<div className="text-6xl font-medium mb-5">See all you can accomplish with Novel</div>
