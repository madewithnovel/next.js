...
export default async function Page () {
	return (
		<div className="w-1/2 min-h-screen mx-auto flex flex-col justify-center">
			<div
				className="border border-stone-200 shadow-lg flex flex-col justify-center mx-auto gap-5 p-10"
				style={{ minWidth: 300, maxWidth: 500 }}>
				<BoxIcon size={42}/>
				<div>
					<div className="text-3xl font-medium">Confirm using your email address</div>
