	...
	return (
		<div className="w-1/2 min-h-screen mx-auto flex flex-col justify-center">
			<div
				...
				<Form/>
				<div>
					<div>Need an account? <Link href="/start?plan=02-novel-freemium">Sign up with your
						email</Link></div>
					<div>Login without a password? <Link href="/login/passwordless">Use a Magic Link</Link></div>
				</div>
